...
public class Main {
  public static void main(String[] args) {
    ...
    // Here box5.weight is not accessible because the TYPE OF OBJECT(i.e boxweight has all four) doesn't determine but TYPE OF REFERENCE VARIABLE ( has only l , h , w) determines what will be be acessible
